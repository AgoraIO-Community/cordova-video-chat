   ...
   module.exports =  {
       ...
       joinChannel: function (appId,  token,  channel,  optionalUID,   peerAccount,  peerName, chatMode, successCallback, failCallback) {
           if (!optionalUID)
               optionalUID = 0;
           ...
           cordova.exec(successCallback, failCallback, 'Agora', 'joinChannel', [appId,  token,  channel,  optionalUID,   peerAccount,  peerName, chatMode]);
       },
       ...
       login: function (appId, token,  account, expiredTime, successCallback, failCallback) {
          
           cordova.exec(successCallback, failCallback, 'Agora', 'login', [appId, token,  account,expiredTime]);
       },
       logout: function (dummy, successCallback, failCallback) {
           cordova.exec(successCallback, failCallback, 'Agora', 'logout', []);
       },
       channelInviteUser: function (appId,  token,  channel,  optionalUID,   account,  accountName, extra, chatMode,successCallback, failCallback) {
          
           cordova.exec(successCallback, failCallback, 'Agora', 'channelInviteUser', [appId,  token,  channel,  optionalUID,   account,  accountName,extra,chatMode]);
       },
       channelInviteEnd:function( channelID, account, uid){
   
            cordova.exec(successCallback, failCallback, 'Agora', 'channelInviteEnd', [ channelID, account, uid]);
   
       },
       queryUserStatus: function(account,successCallback, failCallback) {
           cordova.exec(successCallback, failCallback, 'Agora', 'queryUserStatus', [account]);
       },
   
       
       channelInviteRefuse: function (channelID, account, uid, extra,successCallback, failCallback) {
           cordova.exec(successCallback, failCallback, 'Agora', 'channelInviteRefuse', [channelID, account, uid, extra]);
       },
       channelInviteAccept: function ( channelID, account, uid, extra,successCallback, failCallback) {
           
           cordova.exec(successCallback, failCallback, 'Agora', 'channelInviteAccept', [ channelID, account, uid, extra]);
       },
       unMuteLocalStream: function (dummy, successCallback, failCallback) {
           cordova.exec(successCallback, failCallback, 'Agora', 'unMuteLocalStream', []);
       },
       channelLeave: function (channelID, successCallback, failCallback) { // 信令leave
           cordova.exec(successCallback, failCallback, 'Agora', 'channelLeave', [channelID]);
       },
     
       disableVideo:function (param, successCallback, failCallback){
